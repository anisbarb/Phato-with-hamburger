  ...
  return (
    <div className="relative h-full w-full overflow-hidden select-none bg-[linear-gradient(180deg,#eff6ff_0%,#dbeafe_45%,#eff6ff_100%)]">
      ...
      <button
        ...
        className="absolute z-20 flex items-center justify-center rounded-full bg-white/85 border border-blue-200/60 backdrop-blur-md shadow-[0_2px_12px_rgba(16,33,63,0.08)] text-[#10213f] animate-[fade-in_500ms_ease_both]"
        style={{
      ...
      <MenuSheet
        ...
        onBecomeDriver={() => setLocation("/become-driver")}
      />
    </div>
  );
}
